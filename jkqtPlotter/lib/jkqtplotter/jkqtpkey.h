...
protected:
    ...
    QString framelineRemovalString;
public:

    /** \brief class constructor */
    explicit JKQTPBaseKey(JKQTBasePlotter* parent, QString _removalString);
...
public:
    ...
    /** \brief class constructor */
    explicit JKQTPMainKey(JKQTBasePlotter* parent, QString framelineRemovalString);
    /** \brief class destructor */
