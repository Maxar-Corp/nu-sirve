...
public:
    ...
    /** \brief class constructor
         ...
         */
    explicit JKQTBasePlotter(bool datastore_internal, QObject* parent=nullptr, JKQTPDatastore* datast=nullptr, const QString& _exclusionString = "");
