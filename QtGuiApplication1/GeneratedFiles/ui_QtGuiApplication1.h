...
public:
    ...
    void setupUi(QMainWindow *QtGuiApplication1Class)
    {
        ...
        QWidget::setTabOrder(tabMenu, btn_load_osm);
        QWidget::setTabOrder(btn_load_osm, btn_copy_directory);
        QWidget::setTabOrder(btn_copy_directory, txt_start_frame);
        QWidget::setTabOrder(txt_start_frame, txt_end_frame);
        QWidget::setTabOrder(txt_end_frame, btn_get_frames);
        QWidget::setTabOrder(btn_get_frames, dt_epoch);
        QWidget::setTabOrder(dt_epoch, btn_apply_epoch);
        QWidget::setTabOrder(btn_apply_epoch, btn_frame_save);
        QWidget::setTabOrder(btn_frame_save, btn_frame_record);
        QWidget::setTabOrder(btn_frame_record, btn_prev_frame);
        QWidget::setTabOrder(btn_prev_frame, btn_reverse);
        QWidget::setTabOrder(btn_reverse, btn_pause);
        QWidget::setTabOrder(btn_pause, btn_play);
        QWidget::setTabOrder(btn_play, btn_next_frame);
        QWidget::setTabOrder(btn_next_frame, btn_fast_forward);
        QWidget::setTabOrder(btn_fast_forward, btn_slow_back);
        QWidget::setTabOrder(btn_slow_back, btn_video_menu);
        QWidget::setTabOrder(btn_video_menu, cmb_plot_xaxis);
        QWidget::setTabOrder(cmb_plot_xaxis, cmb_plot_yaxis);
        QWidget::setTabOrder(cmb_plot_yaxis, rad_linear);
        QWidget::setTabOrder(rad_linear, rad_log);
        QWidget::setTabOrder(rad_log, rad_decimal);
        QWidget::setTabOrder(rad_decimal, rad_scientific);
        QWidget::setTabOrder(rad_scientific, btn_plot_menu);
        QWidget::setTabOrder(btn_plot_menu, btn_save_plot);
        QWidget::setTabOrder(btn_save_plot, slider_lift);
        QWidget::setTabOrder(slider_lift, slider_gain);
        QWidget::setTabOrder(slider_gain, chk_relative_histogram);
        QWidget::setTabOrder(chk_relative_histogram, btn_reset_color_correction);
        QWidget::setTabOrder(btn_reset_color_correction, txt_nuc_start);
        QWidget::setTabOrder(txt_nuc_start, txt_nuc_stop);
        QWidget::setTabOrder(txt_nuc_stop, btn_create_nuc);
        QWidget::setTabOrder(btn_create_nuc, chk_apply_nuc);
        QWidget::setTabOrder(chk_apply_nuc, txt_bgs_num_frames);
        QWidget::setTabOrder(txt_bgs_num_frames, btn_bgs);
        QWidget::setTabOrder(btn_bgs, chk_bgs);
        QWidget::setTabOrder(chk_bgs, cmb_deinterlace_options);
        QWidget::setTabOrder(cmb_deinterlace_options, btn_deinterlace);
        QWidget::setTabOrder(btn_deinterlace, chk_deinterlace);
        QWidget::setTabOrder(chk_deinterlace, btn_clear_filters);
        QWidget::setTabOrder(btn_clear_filters, sldrVideo);
        QWidget::setTabOrder(sldrVideo, tabPlots);
        QWidget::setTabOrder(tabPlots, chk_plot_full_data);
        QWidget::setTabOrder(chk_plot_full_data, chk_plot_primary_data);
        QWidget::setTabOrder(chk_plot_primary_data, chk_plot_show_line);
