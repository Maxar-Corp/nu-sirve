...
public:
    ...
    void setupUi(QMainWindow *QtGuiApplication1Class)
    {
        ...
        lbl_file_load->setGeometry(QRect(10, 300, 231, 141));
        ...
        cmb_plot_data = new QComboBox(tab_4);
        cmb_plot_data->setObjectName(QString::fromUtf8("cmb_plot_data"));
        cmb_plot_data->setEnabled(false);
        cmb_plot_data->setGeometry(QRect(480, 530, 181, 22));
        ...
        chk_plot_full_data->setGeometry(QRect(480, 566, 181, 21));
        ...
        QWidget::setTabOrder(btn_slow_back, btn_play_pause);
        QWidget::setTabOrder(btn_play_pause, btn_fast_forward);
    ...
    void retranslateUi(QMainWindow *QtGuiApplication1Class)
    {
        ...
        btn_play_pause->setText(QApplication::translate("QtGuiApplication1Class", "P", nullptr));
