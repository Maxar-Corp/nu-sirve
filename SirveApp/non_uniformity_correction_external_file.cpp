...
void ExternalNUCInformationWidget::PlotOsmFrameData()
{
    ...
    plot_data = new EngineeringPlot(&osm_frames, {Quantity("Irradiance", Enums::PlotUnit::Photons), Quantity("Frames", Enums::PlotUnit::None)}); // TODO: Pull in metadata for this.
