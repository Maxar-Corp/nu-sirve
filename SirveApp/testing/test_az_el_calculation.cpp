...
void TestAzElCalculation::test_azimuth_elevation_calculation()
{
    ...
    std::vector<double> results = AzElCalculation::calculate(boresight_x, boresight_y, sensor_lat_frame_0, sensor_long_frame_0, dcm_frame_0, ifovx, ifovy, adjust_frame_ref);
    ...
    */
    ...
    results = AzElCalculation::calculate(adjusted_track_x, adjusted_track_y, sensor_lat_frame_0, sensor_long_frame_0, dcm_frame_0, ifovx, ifovy, adjust_frame_ref);
    ...
    results = AzElCalculation::calculate(adjusted_track_x, adjusted_track_y, sensor_lat_frame_1, sensor_long_frame_1, dcm_frame_1, ifovx, ifovy, adjust_frame_ref);
