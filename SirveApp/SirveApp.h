...
public:
    ...
    QComboBox * cmb_OSM_track_IDs, * cmb_manual_track_IDs, *cmb_deinterlace_choice;
...
private:
    ...
    void CenterOnTracks(QString trackTypePriority, int track_id, std::vector<std::vector<int>> & track_centered_offsets, int processing_state_idx);
