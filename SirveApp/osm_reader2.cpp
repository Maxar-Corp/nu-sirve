...
TrackData OSMReader2::GetTrackData(const FrameData& input)
{
...
std::vector<double> OSMReader2::CalculateAzimuthElevation(int x_pixel, int y_pixel, const FrameData& input)
{
...
std::vector<double> OSMReader2::CalculateDirectionCosineMatrix(const std::vector<double>& input)
{
    arma::vec mr(input);
...
std::vector<double> OSMReader2::CalculateLatLonAltVector(const std::vector<double>& ecf)
{
