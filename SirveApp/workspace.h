...
class Workspace {
    public:
        ...
        void SaveState(QString full_workspace_file_path, QString image_path, int start_frame, int end_frame, const std::vector<processingState> all_states, const std::vector<AnnotationInfo> annotations);
