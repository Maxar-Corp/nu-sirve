...
namespace SharedTrackingFunctions
{
    ...
    void GetFrameRepresentations(uint & indx, double & clamp_low_coeff, double & clamp_high_coeff, VideoDetails & current_processing_state_details, VideoDetails & base_processing_state_details, cv::Mat & frame, std::string & prefilter, cv::Mat & display_frame,  cv::Mat & raw_display_frame, cv::Mat & clean_display_frame, cv::Mat & raw_frame);
