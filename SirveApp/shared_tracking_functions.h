...
{
    std::array<double, 3> CalculateIrradiance(int indx, cv::Rect boundingBox, const VideoDetails & base_processing_state_details, double frame_integration_time, CalibrationData & calibration_model);
